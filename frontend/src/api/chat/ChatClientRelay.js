...
export default class ChatClientRelay {
  ...
  getReconnectInterval() {
    return Math.min(1000 + (this.retryCount - 1) * 2000, 10 * 1000);
  }
    ...
    switch (cmd) {
      ...
      case COMMAND_ADD_TEXT: {
        ...
        data = {
          ...
          isGiftDanmaku:
            Boolean(data[6]) || chat.isGiftDanmakuByContent(content),
          authorLevel: data[7],
